...
public class MeiNvActivity extends BaseActivity
        implements NavigationView.OnNavigationItemSelectedListener {


    private ViewPager mViewPager;
    private String[] mTitles;
    private MeiNvFragment[] fragments;
private     TabLayout tabLayout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTitles = getResources().getStringArray(R.array.meinv_titles);

        mViewPager = (ViewPager) findViewById(viewPager);

        tabLayout=(TabLayout) findViewById(R.id.tab_layout);

        fragments = new MeiNvFragment[mTitles.length];

        for(int i=0;i<mTitles.length;i++) {
            fragments[i] =  new MeiNvFragment();
        }
